...
# Sublime Code Formatter

when i write code it is not easy to maintan a good formating style all the time. So i use `SublimeAStyleFormatter` extension for formate my source code.
## Installation
